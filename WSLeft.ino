...
/*We are using capactive sensors to trigger the sounds below. Therefore, we define the pins here*/
...
and it meets the threshold, a sound will execute, along with the reading value of the sensor, respectively*/ 
    ...
    int threshold = 200;
      ...
      if(sensor1>threshold){
        playfile("GuitarA.WAV");
        Serial.println(sensor1);
      }
      
      if(sensor2>threshold){
        playfile("GuitarB.WAV");
